...
Page({
      ...
      api.getMusicDetailById({
        ...
        success: (res) => {
          if (res.data.res === 0) {
            ...
            music.last_update_date = util.musicupdata(music.last_update_date)
            console.log(music.last_update_date)
            musics.push(music)
          }
          this.getMusics(idList)
        } 
  ...
  togglePlay:function (e) {
    ...
    musics = musics.map((music) => {
      music.playImg = "../../../images/music_play.png"
      return music
    })
    ...
    if (playId !== musicId) {
      ...
      playId = -1
      music.playImg = "../../../images/music_pause.png"
      this.pauseMusic()
    }
